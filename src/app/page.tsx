...
export default function Home() {
  const skills = [
    ...
    },
    {
      ...
      rating: 75,
      description:
        'I know how to use Tailwind for layouts, spacing, typography, and responsive design. I can style most UI elements, but I’m still missing some mastery with transitions, pseudo-states, arbitrary values, dark mode, and deeper Tailwind config customization.',
    ...
    <div className="min-h-screen animated-gradient text-white font-body select-none scroll-smooth overflow-x-hidden">    
      ...
      <header className="fixed top-3 left-1/2 -translate-x-1/2 w-full max-w-5xl px-3 sm:px-6 z-50">
        <nav className="glass-nav px-4 sm:px-6 py-2.5 sm:py-3 flex items-center justify-between rounded-2xl shadow-lg glass-border border border-white/10">
          ...
          <ul className="hidden md:flex gap-4 lg:gap-6 font-heading text-sm lg:text-base">
            {navItems.map((item) => (
              <li
                key={item}
                className="relative cursor-pointer px-3 lg:px-4 py-2 overflow-hidden rounded-md before:content-[''] before:absolute before:inset-0 before:rounded-md before:scale-0 before:opacity-0 before:origin-center before:bg-gradient-to-r before:from-purple-600 before:to-pink-500 before:bg-[length:200%_200%] before:animate-[gradientMove_3s_linear_infinite] before:transition-all before:duration-250 hover:before:scale-110 hover:before:opacity-100"
              >
          ...
          <button
            ...
            className="md:hidden inline-flex items-center justify-center rounded-xl px-3 py-2 bg-white/10 hover:bg-white/20 transition focus:outline-none focus:ring-2 focus:ring-white/40">
            <svg
        ...
        {mobileOpen && (
          <div
            id="mobile-menu"
            className="md:hidden mt-2 rounded-2xl bg-black/50 backdrop-blur-xl border border-white/10 p-2">
            {navItems.map((item) => (
              <a
                key={item}
                href={`#${item.toLowerCase()}`}
                onClick={() => setMobileOpen(false)}
                className="block w-full px-4 py-2 rounded-xl hover:bg-white/10 text-sm">
                {item}
              </a>
            ))}
          </div>
      ...
      <section
        ...
        <p className="max-w-4xl leading-relaxed text-base sm:text-lg md:text-xl lg:text-2xl">
          Final-Year Student | Software Engineering @ SMKN 4 Bandung
        </p>
        <div className="font-mono mt-2 text-base sm:text-lg md:text-xl">
          <Typewriter
            options={{
              strings: [
                'Aspiring Fullstack Developer.',
                'I love music, and game the most.',
                'I love making ROBLOX games too!',
                'Always Learning 🚀',
              ],
              autoStart: true,
              loop: true,
        ...
        <a
          ...
          className="relative z-0 cursor-pointer mt-6 p-2.5 sm:p-3 before:content-[''] before:absolute before:inset-0 before:rounded-full before:scale-0 before:opacity-0 before:bg-[#000000] before:transition-all before:duration-300 hover:before:scale-100 hover:before:opacity-100 before:-z-10">
      ...
      <section
        id="about"
        className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 scroll-mt-28">
        ...
        <p className="leading-relaxed text-base sm:text-lg md:text-[23.4px] text-gray-300">
      ...
      <section id="contact" className="py-16 sm:py-20 px-4 sm:px-6 text-center max-w-3xl mx-auto scroll-mt-28">
        ...
        <a
          ...
          className="inline-block px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg bg-purple-600 hover:bg-purple-700 transition shadow-lg text-sm sm:text-base">
          Send me an Email
        </a>

        <p className="mt-8 sm:mt-10 text-xs sm:text-[14.6px] font-bold">Or</p>

        <div className="flex justify-center gap-5 sm:gap-6 mt-6 sm:mt-8 text-base">
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://discord.com/users/743068550918438982"
            className="relative z-0 cursor-pointer p-2.5 sm:p-3 before:content-[''] before:absolute before:inset-0 before:rounded-full before:scale-0 before:opacity-0 before:bg-[#7289DA] before:transition-all before:duration-300 hover:before:scale-100 hover:before:opacity-100 before:-z-10">
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://instagram.com/dzakgun_"
            className="relative z-0 cursor-pointer p-2.5 sm:p-3 before:content-[''] before:absolute before:inset-0 before:rounded-full before:scale-0 before:opacity-0 before:bg-gradient-to-br before:from-[#f9ce34] before:via-[#ee2a7b] before:to-[#6228d7] before:transition-all before:duration-300 hover:before:scale-100 hover:before:opacity-100 before:-z-10">
            <span className="[&>svg]:h-5 [&>svg]:w-5">
      ...
      <footer className="py-6 text-center opacity-60 text-xs sm:text-sm">
